<?php
    ...
    $buffer=str_replace("%TITLE%","NIKE",$buffer);
    echo $buffer;
?>
  <!-- Gallery -->
  <!-- Menu -->
    ...
    <div class="container" style="font-size: 12px;">
      <div class="row">
        <div class="text-center mx-auto col-md-12">
          <h1>Tous les modèles de Nike</h1>
        </div>
      </div>
      <div class="row">
        <div class="col-lg-6 p-3">
          <div class="card text-center">
            ...
            <div class="card-body p-3">
              ...
              <a class="btn btn-primary" href="Nike/AM270.php" draggable="true">Voir les modèles</a>
            </div>
          </div>
        </div>
        <div class="col-lg-6 p-3">
          ...
          <!-- <div class="col-lg-4 p-3">
            <div class="card text-center">
              ...
              <div class="card-body p-3">
                ...
                <a class="btn btn-primary" href="Nike/AM95.php">Voir les modèles</a>
              </div>
            </div>
          </div>
         <div class="col-lg-4 p-3">
          ...
          <div class="col-lg-6 p-3">
            <div class="card text-center">
              ...
              <div class="card-body p-3" >
                ...
                <a class="btn btn-primary" href="Nike/AVMP.php">Voir les modèles</a>
              </div>
            </div>
          </div>
          <div class="col-lg-6 p-3">
            <div class="card text-center">
              ...
              <div class="card-body p-3">
                ...
                <a class="btn btn-primary" href="Nike/TN.php">Voir les modèles</a>
              </div>
            </div>
          </div>
          <div class="col-lg-6 p-3">
